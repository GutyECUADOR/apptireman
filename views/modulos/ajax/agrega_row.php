<div class="col s12 m12 l12" name="row_productos[]">
    ...
    <div class="input-field col s12 m6 l5">
        <input type="text" id="testinput1" class="autocomplete center-align uppercase rowproducto" name="txt_detalle_product[]" placeholder="Indique item" onchange="ajaxvalidacod_producto(this);calcular_total_productos()" onfocus="autocompletadoOK()">
