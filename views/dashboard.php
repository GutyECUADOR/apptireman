...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <!-- Chart.js -->
    <script src="<?php echo ROOT_PATH; ?>assets/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="<?php echo ROOT_PATH; ?>assets/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    <script src="<?php echo ROOT_PATH; ?>assets/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    <script src="<?php echo ROOT_PATH; ?>assets/iCheck/icheck.min.js"></script>
    <!-- Skycons -->
    <script src="<?php echo ROOT_PATH; ?>assets/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="<?php echo ROOT_PATH; ?>assets/Flot/jquery.flot.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/Flot/jquery.flot.pie.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/Flot/jquery.flot.time.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/Flot/jquery.flot.stack.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="<?php echo ROOT_PATH; ?>assets/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="<?php echo ROOT_PATH; ?>assets/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="<?php echo ROOT_PATH; ?>assets/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo ROOT_PATH; ?>assets/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <!-- bootstrap-daterangepicker -->
